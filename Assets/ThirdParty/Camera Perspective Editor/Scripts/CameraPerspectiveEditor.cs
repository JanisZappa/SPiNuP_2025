...
public class CameraPerspectiveEditor : MonoBehaviour
{
	...
	public Vector2 lensShift = V2.zero;
	public bool lensShiftProportionalToAspect;
	
	//Lens Tilt
	public Vector2 lensTilt = V2.zero;

	//Position Shift
	public Vector2 positionShift = V2.zero;
	
	//Skew
	public Vector2 skew = V2.zero;
	
	//Aspect Scale
	public Vector2 aspectScale = Vector2.one;

	//Clipping Plane Skew
	public Vector2 clippingPlaneSkew = V2.zero;
